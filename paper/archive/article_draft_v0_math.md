...
`paper/article_draft_v0.html`. This Markdown/LaTeX copy is retained as a plain
source backup.
...
used to evaluate realized consequences. The endogenous object is $\theta_t$,
the preference state. The question is what these operators are applied to after
