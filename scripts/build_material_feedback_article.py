...
<main>
  ...
  <section class="abstract">
    ...
    <p>Preferences have never been literally fixed. In slower environments, however, taste formation, institutional adjustment, and material feedback often moved on comparable clocks, so economics could treat preferences as quasi-fixed while studying equilibrium. The internet, social media, recommender systems, and AI change the time scale. They can move subjective payoffs quickly, experimentally, and for many people at once, before social capacities, institutions, populations, or markets have time to settle.</p>
  ...
  <section>
    ...
    <p>Tastes have always changed. Fashion, religion, education, advertising, urban life, war, migration, and markets have always altered what people want. That is not the novelty. The novelty is the speed and scale at which payoff-forming environments can now operate. A ranked feed, viral norm, app interface, or AI companion can change salience and reward almost immediately. It can also do so for millions of people at once. The old fixed-preference approximation was most defensible when taste formation, material feedback, and institutional response had time to catch each other. It is less defensible when subjective payoffs can be moved into unfamiliar regions before capacity, law, family formation, schools, firms, or political institutions adjust.</p>

    <p>This timing gap changes the economics. If a new payoff-forming rule merely produces a passing fad, the old equilibrium machinery can absorb it. If it changes choices that build or deplete slow capacities, the short run is no longer harmless. A system may damage social skill, solvency, health, trust, learning, fertility agency, or verification capacity before slower Darwinian or institutional feedback can push back. Worse, the feedback may not push toward material viability if the competitive score rewards attention, retention, revenue, or imitation instead.</p>
    ...
    <p>These examples differ morally, psychologically, and institutionally, but the same quantities make them comparable: the exposure that changes what feels rewarding, the substitute behavior, the material capacity changed by that behavior, and the competitive score that determines which payoff-forming rule spreads. A platform may reward retention. A clinical trial may reward restored social life. A political market may reward attention. A household may care about solvency. The same local choice can be rational under each score, while the long-run capacity path differs.</p>

    <p>Government is part of the same dynamic when collective rules change exposure, damage, repair, enforcement, or the competitive score. A rule that only announces concern is an alarm. A rule that changes the capacity path is a force in the system.</p>
    ...
    <p>The result is not a moral ranking of old and new tastes. It is a classification of paths. Some fast payoff systems help rebuild the slower capacity that keeps future options open. Some make a substitute attractive exactly when that capacity is weak, so the system can settle into a low-capacity routine. Competition then decides which payoff-forming rules spread, but it preserves capacity only when the winning score rewards capacity rather than attention, revenue, imitation, or political heat.</p>
  </section>
  ...
  <section>
    ...
    <p>When the clocks are close, fixed-preference equilibrium analysis may be a good approximation. Preferences move, but the economy has time to reprice, relearn, regulate, imitate, or select. The limiting case studied here is different: subjective payoffs move first, at population scale, while material capacity moves later. That is where short-run damage is possible even if long-run selection eventually responds.</p>
  ...
  <section>
    ...
    <p>GLP-1 medicines illustrate a possible repair case. A fast change in appetite payoff can be a bridge if it rebuilds durable metabolic capacity. It is a sink only if it creates dependence without rebuilding the stock that makes healthier eating and weight maintenance feasible outside the product.</p>
