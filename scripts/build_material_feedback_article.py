  ...
  <section>
    ...
    <div class="result-list">
      ...
      <ol>
        ...
        <li><strong>Trap.</strong> The substitute is most attractive when capacity is weak, and using it can crowd out the practice or exposure that would rebuild capacity. A threshold separates recovery from persistence in the low state.</li>
