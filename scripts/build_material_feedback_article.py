...
<main>
  ...
  <section>
    ...
    <p>Four quantities track the case. Exposure is the interface, product, feed, norm, or institution that changes what feels rewarding. The substitute behavior is the quick option chosen under that payoff. Material capacity is the slower stock changed by the behavior: social skill, solvency, health, learning, trust, or institutional competence. The competitive score determines which payoff-forming rule spreads: clinical success, attention, revenue, imitation, votes, or material survival.</p>
  ...
  <section>
    ...
    <p>In the figures, \(K\) is normalized capacity and \(p\) is the share of behavior going to the substitute. Capacity drift is the instantaneous change in \(K\). A root of the drift curve is a resting point. Filled roots are stable. An open root is a threshold.</p>
